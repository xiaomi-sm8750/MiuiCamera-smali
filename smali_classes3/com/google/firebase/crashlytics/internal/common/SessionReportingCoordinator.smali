...
.method private static convertApplicationExitInfo(Landroid/app/ApplicationExitInfo;)Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport$ApplicationExitInfo;
    ...
    :try_start_0
    invoke-static {p0}, Landroidx/core/view/L;->c(Landroid/app/ApplicationExitInfo;)Ljava/io/InputStream;
    ...
    invoke-static {p0}, Landroidx/core/view/B;->c(Landroid/app/ApplicationExitInfo;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/core/view/C;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {p0}, Landroidx/window/layout/a;->d(Landroid/app/ApplicationExitInfo;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/window/layout/b;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {p0}, Landroidx/core/view/F;->c(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-static {p0}, Landroidx/window/layout/b;->e(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {p0}, Landroidx/core/view/F;->g(Landroid/app/ApplicationExitInfo;)J
...
.method private findRelevantApplicationExitInfo(Ljava/lang/String;Ljava/util/List;)Landroid/app/ApplicationExitInfo;
    ...
    invoke-static {v0}, Landroidx/window/layout/a;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v0

    invoke-static {v0}, Landroidx/core/view/F;->c(Landroid/app/ApplicationExitInfo;)J
    ...
    :cond_0
    invoke-static {v0}, Landroidx/window/layout/b;->a(Landroid/app/ApplicationExitInfo;)I
...
.method private static getSortedCustomAttributes(Ljava/util/Map;)Ljava/util/List;
    ...
    :cond_0
    new-instance p0, Lad/x;

    const/4 v1, 0x1

    invoke-direct {p0, v1}, Lad/x;-><init>(I)V
...
.method private persistEvent(Ljava/lang/Throwable;Ljava/lang/Thread;Ljava/lang/String;Lcom/google/firebase/crashlytics/internal/metadata/EventMetadata;Z)V
    ...
    invoke-direct {p3, p0, p1, p4, v0}, LBb/n;-><init>(Lcom/google/firebase/crashlytics/internal/common/SessionReportingCoordinator;Lcom/google/firebase/crashlytics/internal/model/CrashlyticsReport$Session$Event;Lcom/google/firebase/crashlytics/internal/metadata/EventMetadata;Z)V
...
.method public sendReports(Ljava/util/concurrent/Executor;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v3, p0, v4}, LKa/c;-><init>(Ljava/lang/Object;I)V
