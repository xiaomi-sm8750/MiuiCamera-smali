...
.method static constructor <clinit>()V
    ...
    const-string v4, "Property get/get failed"

    const-string v5, "PROPERTY_STATUS_FAILED"

    const/4 v6, 0x2

    invoke-direct {v2, v5, v6, v3, v4}, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    new-instance v3, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    const/4 v4, -0x2

    const-string v5, "Property has no co-respond access"

    const-string v6, "PROPERTY_STATUS_FAILED_NO_ACCESS"

    const/4 v7, 0x3

    invoke-direct {v3, v6, v7, v4, v5}, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v3, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;->PROPERTY_STATUS_FAILED_NO_ACCESS:Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    new-instance v4, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    const/4 v5, -0x3

    const-string v6, "Property value bytes parse error"

    const-string v7, "PROPERTY_STATUS_SET_FAILED_PROPERTY_VALUE_PARSE_ERR"

    const/4 v8, 0x4

    invoke-direct {v4, v7, v8, v5, v6}, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v4, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;->PROPERTY_STATUS_SET_FAILED_PROPERTY_VALUE_PARSE_ERR:Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    new-instance v5, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    const/16 v6, -0x270f

    const-string v7, "Unknown property status"

    const-string v8, "PROPERTY_STATUS_UNKNOWN"

    const/4 v9, 0x5

    invoke-direct {v5, v8, v9, v6, v7}, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v5, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;->PROPERTY_STATUS_UNKNOWN:Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    filled-new-array/range {v0 .. v5}, [Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;->$VALUES:[Lcom/xiaomi/idm/constant/ResponseCode$PropertyStatusCode;
