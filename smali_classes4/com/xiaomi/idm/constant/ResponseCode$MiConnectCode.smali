...
.method static constructor <clinit>()V
    ...
    const-string v4, "MiConnect onBindingDied"

    const-string v5, "MI_CONNECT_ERR_ON_BINDING_DIED"

    const/4 v6, 0x2

    invoke-direct {v2, v5, v6, v3, v4}, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    new-instance v3, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    const/16 v4, -0x232a

    const-string v5, "MiConnect onNullBinding"

    const-string v6, "MI_CONNECT_ERR_ON_NULL_BINDING"

    const/4 v7, 0x3

    invoke-direct {v3, v6, v7, v4, v5}, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v3, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;->MI_CONNECT_ERR_ON_NULL_BINDING:Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    new-instance v4, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    const/16 v5, -0x232b

    const-string v6, "MiConnect Version too low"

    const-string v7, "MI_CONNECT_ERR_VERSION_TOO_LOW"

    const/4 v8, 0x4

    invoke-direct {v4, v7, v8, v5, v6}, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v4, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;->MI_CONNECT_ERR_VERSION_TOO_LOW:Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    new-instance v5, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    const/16 v6, -0x232c

    const-string v7, "MiConnect Could not be found on device or Permission denied"

    const-string v8, "MI_CONNECT_ERR_NOT_FOUND"

    const/4 v9, 0x5

    invoke-direct {v5, v8, v9, v6, v7}, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v5, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;->MI_CONNECT_ERR_NOT_FOUND:Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    new-instance v6, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    const/16 v7, -0x232d

    const-string v8, "MiConnect report an exception"

    const-string v9, "MI_CONNECT_ERR_REMOTE_EXCEPTION"

    const/4 v10, 0x6

    invoke-direct {v6, v9, v10, v7, v8}, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v6, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;->MI_CONNECT_ERR_REMOTE_EXCEPTION:Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    new-instance v7, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    const/16 v8, -0x270f

    const-string v9, "Unknown response code"

    const-string v10, "MI_CONNECT_UNKNOWN"

    const/4 v11, 0x7

    invoke-direct {v7, v10, v11, v8, v9}, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v7, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;->MI_CONNECT_UNKNOWN:Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    filled-new-array/range {v0 .. v7}, [Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;

    move-result-object v0

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;->$VALUES:[Lcom/xiaomi/idm/constant/ResponseCode$MiConnectCode;
