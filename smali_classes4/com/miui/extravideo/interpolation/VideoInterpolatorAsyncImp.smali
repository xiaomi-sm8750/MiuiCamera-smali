...
.method public constructor <init>(IILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;[FZ)V
    ...
    iput v6, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSkipSizeTarget2Origin:I
    ...
    .line 21
    iput v6, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mFrameSizeInterpolation:I
    ...
    .line 24
    :goto_1
    iput-boolean v1, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSupportWatermark:Z

    move/from16 v2, p7

    .line 25
    iput-boolean v2, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSupportEditor:Z

    move-object/from16 v2, p4

    .line 26
    iput-object v2, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDstPath:Ljava/lang/String;

    .line 27
    iput-object v3, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mSrcPath:Ljava/lang/String;

    .line 28
    new-instance v4, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;

    const-string v6, "DecodeThread"

    invoke-direct {v4, v6}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v4, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDecodeThread:Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;

    .line 29
    new-instance v4, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;

    const-string v6, "EncodeThread"

    invoke-direct {v4, v6}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v4, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncodeThread:Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;

    .line 30
    new-instance v4, Lcom/miui/extravideo/common/MediaDecoderAsync;

    iget-object v6, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDecodeThread:Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;

    invoke-static {v6}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;->a(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;)Landroid/os/Handler;

    move-result-object v6

    invoke-direct {v4, v3, v6}, Lcom/miui/extravideo/common/MediaDecoderAsync;-><init>(Ljava/lang/String;Landroid/os/Handler;)V

    iput-object v4, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDecoder:Lcom/miui/extravideo/common/MediaDecoderAsync;

    .line 31
    invoke-virtual {v4}, Lcom/miui/extravideo/common/MediaDecoderAsync;->getMediaParamsHolder()Lcom/miui/extravideo/common/MediaParamsHolder;

    move-result-object v3

    .line 32
    iget v9, v3, Lcom/miui/extravideo/common/MediaParamsHolder;->videoDegree:I

    iput v9, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mDegree:I

    .line 33
    new-instance v4, Lcom/miui/extravideo/common/MediaEncoderAsync;

    iget v7, v3, Lcom/miui/extravideo/common/MediaParamsHolder;->videoWidth:I

    iget v8, v3, Lcom/miui/extravideo/common/MediaParamsHolder;->videoHeight:I

    iget-object v10, v3, Lcom/miui/extravideo/common/MediaParamsHolder;->mimeType:Ljava/lang/String;

    iget-object v6, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncodeThread:Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$MediaCodecHandlerThread;
    ...
    invoke-direct/range {v6 .. v12}, Lcom/miui/extravideo/common/MediaEncoderAsync;-><init>(IIILjava/lang/String;Ljava/lang/String;Landroid/os/Handler;)V

    iput-object v4, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncoder:Lcom/miui/extravideo/common/MediaEncoderAsync;
    ...
    new-instance v4, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$DecodeUpdateListener;

    invoke-direct {v4, p0, v3}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$DecodeUpdateListener;-><init>(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;Lcom/miui/extravideo/common/MediaParamsHolder;)V

    invoke-virtual {v2, v4}, Lcom/miui/extravideo/common/MediaDecoderAsync;->setListener(Lcom/miui/extravideo/common/MediaDecoderAsync$DecodeUpdateListener;)V
    ...
    new-instance v4, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$EncodeUpdateListener;

    invoke-direct {v4, p0, v5}, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp$EncodeUpdateListener;-><init>(Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;I)V

    invoke-virtual {v2, v4}, Lcom/miui/extravideo/common/MediaEncoderAsync;->setListener(Lcom/miui/extravideo/common/MediaEncoderAsync$EncodeUpdateListener;)V

    .line 36
    new-instance v2, Lcom/miui/extravideo/interpolation/BufferPool;

    invoke-direct {v2}, Lcom/miui/extravideo/interpolation/BufferPool;-><init>()V

    iput-object v2, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mBufferPool:Lcom/miui/extravideo/interpolation/BufferPool;

    if-eqz v1, :cond_2

    .line 37
    new-instance v6, Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;

    invoke-direct {v6}, Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;-><init>()V

    iput-object v6, v0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mWatermarkPipeline:Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;
    ...
    iget v11, v3, Lcom/miui/extravideo/common/MediaParamsHolder;->videoDegree:I

    move-object/from16 v9, p5

    move-object/from16 v10, p6

    invoke-virtual/range {v6 .. v11}, Lcom/miui/extravideo/watermark/WatermarkRenderPipeline;->init(IILandroid/graphics/Bitmap;[FI)V
