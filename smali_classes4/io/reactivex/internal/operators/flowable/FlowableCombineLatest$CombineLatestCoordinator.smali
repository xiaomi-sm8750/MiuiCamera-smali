...
# direct methods
.method public constructor <init>(LHj/c;Lio/reactivex/functions/Function;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:LHj/c;
...
.method public drainAsync()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:LHj/c;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLHj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLHj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
...
.method public drainOutput()V
    ...
    invoke-interface {v0, v3}, LHj/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v5}, LHj/c;->onNext(Ljava/lang/Object;)V
...
.method public subscribe([LHj/b;I)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
