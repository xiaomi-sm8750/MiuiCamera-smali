...
.method public constructor <init>(LHj/b;LHj/b;Lio/reactivex/functions/BiPredicate;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:LHj/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:LHj/b;
...
.method public subscribeActual(LHj/c;)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;-><init>(LHj/c;ILio/reactivex/functions/BiPredicate;)V

    invoke-interface {p1, v0}, LHj/c;->onSubscribe(LHj/d;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:LHj/b;

    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:LHj/b;

    invoke-virtual {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;->subscribe(LHj/b;LHj/b;)V
