...
.method public createAudioEncoder()V
    ...
    iget-boolean v2, p0, Lcom/xiaomi/fenshen/VideoRecorder;->withAudio:Z
    ...
    invoke-virtual {v5, v3, v0}, Landroid/media/MediaFormat;->setByteBuffer(Ljava/lang/String;Ljava/nio/ByteBuffer;)V
    ...
    iput-object v0, p0, Lcom/xiaomi/fenshen/VideoRecorder;->audioEncoder:Landroid/media/MediaCodec;
    ...
    invoke-virtual {p0, v5, v0, v0, v4}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    :try_end_0
    ...
    const-string v0, "create audio encoder failed!"
...
.method public stopRecorder(I)V
    ...
    const-string/jumbo v0, "stop video encoder"
    ...
    const-string/jumbo p1, "stop audio encoder"
    ...
    const-string/jumbo p1, "stop muxer"
