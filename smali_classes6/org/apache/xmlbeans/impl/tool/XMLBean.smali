...
.method public execute()V
    ...
    iget-object v3, p0, Lorg/apache/xmlbeans/impl/tool/XMLBean;->schema:Ljava/io/File;

    invoke-virtual {p0, v3}, Lorg/apache/xmlbeans/impl/tool/XMLBean;->getDirectoryScanner(Ljava/io/File;)Lorg/apache/tools/ant/DirectoryScanner;

    move-result-object v3

    invoke-interface {v3}, Lorg/apache/tools/ant/FileScanner;->getIncludedFiles()[Ljava/lang/String;

    move-result-object v8

    invoke-interface {v3}, Lorg/apache/tools/ant/FileScanner;->getBasedir()Ljava/io/File;

    move-result-object v3

    invoke-direct {p0, v8, v3}, Lorg/apache/xmlbeans/impl/tool/XMLBean;->processPaths([Ljava/lang/String;Ljava/io/File;)V
    ...
    invoke-direct {p0, v3, v1}, Lorg/apache/xmlbeans/impl/tool/XMLBean;->processPaths([Ljava/lang/String;Ljava/io/File;)V

    :cond_3
    :goto_0
    iget-object v3, p0, Lorg/apache/xmlbeans/impl/tool/XMLBean;->fileset:Lorg/apache/tools/ant/types/FileSet;

    iget-object v8, p0, Lorg/apache/xmlbeans/impl/tool/XMLBean;->project:Lorg/apache/tools/ant/Project;

    invoke-virtual {v3, v8}, Lorg/apache/tools/ant/types/FileSet;->getDir(Lorg/apache/tools/ant/Project;)Ljava/io/File;

    move-result-object v3

    if-eqz v3, :cond_4

    iget-object v3, p0, Lorg/apache/xmlbeans/impl/tool/XMLBean;->schemas:Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v9}, Lorg/apache/tools/ant/types/FileSet;->getDirectoryScanner(Lorg/apache/tools/ant/Project;)Lorg/apache/tools/ant/DirectoryScanner;
    ...
    invoke-direct {p0, v8, v9}, Lorg/apache/xmlbeans/impl/tool/XMLBean;->processPaths([Ljava/lang/String;Ljava/io/File;)V
    ...
    iget-object v4, p0, Lorg/apache/xmlbeans/impl/tool/XMLBean;->_extRouter:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, v0, v5}, Lorg/apache/xmlbeans/impl/tool/XMLBean;->log(Ljava/lang/String;I)V
    ...
    invoke-virtual {v10, v3}, Lorg/apache/xmlbeans/impl/tool/SchemaCompiler$Parameters;->setXsdFiles([Ljava/io/File;)V

    invoke-virtual {v10, v4}, Lorg/apache/xmlbeans/impl/tool/SchemaCompiler$Parameters;->setWsdlFiles([Ljava/io/File;)V
    ...
    invoke-virtual {v10, v5}, Lorg/apache/xmlbeans/impl/tool/SchemaCompiler$Parameters;->setNojavac(Z)V
