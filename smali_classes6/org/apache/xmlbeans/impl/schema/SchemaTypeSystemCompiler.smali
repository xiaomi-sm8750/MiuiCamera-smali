...
.method public static compileImpl(Lorg/apache/xmlbeans/SchemaTypeSystem;Ljava/lang/String;[Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;Lorg/apache/xmlbeans/BindingConfig;Lorg/apache/xmlbeans/SchemaTypeLoader;Lorg/apache/xmlbeans/XmlOptions;Ljava/util/Collection;ZLjava/net/URI;Ljava/util/Map;Ljava/io/File;)Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemImpl;
    ...
    new-instance v2, Lorg/apache/xmlbeans/impl/common/XmlErrorWatcher;

    invoke-direct {v2, p6}, Lorg/apache/xmlbeans/impl/common/XmlErrorWatcher;-><init>(Ljava/util/Collection;)V
    ...
    :goto_2
    :try_start_0
    invoke-virtual {v3, v2}, Lorg/apache/xmlbeans/impl/schema/StscState;->setErrorListener(Ljava/util/Collection;)V
    ...
    new-array p3, p3, [Lorg/apache/xmlbeans/SchemaTypeLoader;
    ...
    invoke-static {p3, p1, p1}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeLoaderImpl;->build([Lorg/apache/xmlbeans/SchemaTypeLoader;Lorg/apache/xmlbeans/ResourceLoader;Ljava/lang/ClassLoader;)Lorg/apache/xmlbeans/SchemaTypeLoader;

    move-result-object p3

    invoke-virtual {v3, p3}, Lorg/apache/xmlbeans/impl/schema/StscState;->setImportingTypeLoader(Lorg/apache/xmlbeans/SchemaTypeLoader;)V
    ...
    invoke-virtual {p4, v2}, Lorg/apache/xmlbeans/XmlOptions;->setErrorListener(Ljava/util/Collection;)Lorg/apache/xmlbeans/XmlOptions;
    ...
    check-cast p2, [Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;
    ...
    invoke-static {p4, p2, p3}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemCompiler;->getSchemasToRecompile(Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemImpl;[Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;Ljava/util/Set;)[Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;
    ...
    invoke-virtual {v3, p4, p3}, Lorg/apache/xmlbeans/impl/schema/StscState;->initFromTypeSystem(Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemImpl;Ljava/util/Set;)V

    goto :goto_5

    :cond_8
    new-instance p3, Lorg/apache/xmlbeans/impl/schema/SchemaDependencies;

    invoke-direct {p3}, Lorg/apache/xmlbeans/impl/schema/SchemaDependencies;-><init>()V

    invoke-virtual {v3, p3}, Lorg/apache/xmlbeans/impl/schema/StscState;->setDependencies(Lorg/apache/xmlbeans/impl/schema/SchemaDependencies;)V

    :goto_5
    invoke-static {p2, p6}, Lorg/apache/xmlbeans/impl/schema/StscImporter;->resolveImportsAndIncludes([Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;Z)[Lorg/apache/xmlbeans/impl/schema/StscImporter$SchemaToProcess;

    move-result-object p2

    invoke-static {p2}, Lorg/apache/xmlbeans/impl/schema/StscTranslator;->addAllDefinitions([Lorg/apache/xmlbeans/impl/schema/StscImporter$SchemaToProcess;)V
    ...
    invoke-virtual {p2}, Lorg/apache/xmlbeans/impl/schema/StscState;->sts()Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemImpl;

    move-result-object p2

    invoke-virtual {p2, v3}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemImpl;->loadFromStscState(Lorg/apache/xmlbeans/impl/schema/StscState;)V
    ...
    invoke-interface {p9, p2}, Ljava/util/Map;->putAll(Ljava/util/Map;)V

    :cond_9
    invoke-virtual {v2}, Lorg/apache/xmlbeans/impl/common/XmlErrorWatcher;->hasError()Z
    ...
    invoke-virtual {v2}, Lorg/apache/xmlbeans/impl/common/XmlErrorWatcher;->size()I
...
.method private static getSchemasToRecompile(Lorg/apache/xmlbeans/impl/schema/SchemaTypeSystemImpl;[Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;Ljava/util/Set;)[Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;
    ...
    invoke-static {v1, p2, p0}, Lorg/apache/xmlbeans/impl/schema/StscImporter$DownloadTable;->downloadDocument(Lorg/apache/xmlbeans/SchemaTypeLoader;Ljava/lang/String;Ljava/lang/String;)Lorg/apache/xmlbeans/XmlObject;
    ...
    invoke-virtual {v6}, Lorg/apache/xmlbeans/impl/schema/StscState;->getErrorListener()Ljava/util/Collection;

    move-result-object v6

    invoke-virtual {v5, v6}, Lorg/apache/xmlbeans/XmlOptions;->setErrorListener(Ljava/util/Collection;)Lorg/apache/xmlbeans/XmlOptions;

    instance-of v6, v1, Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument;

    if-eqz v6, :cond_3

    invoke-interface {v1, v5}, Lorg/apache/xmlbeans/XmlObject;->validate(Lorg/apache/xmlbeans/XmlOptions;)Z
    ...
    invoke-interface {v1}, Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument;->getSchema()Lorg/apache/xmlbeans/impl/xb/xsdschema/SchemaDocument$Schema;
    ...
    const-string v6, "Referenced document is not a valid schema, URL = "
    ...
    invoke-virtual {v1, v5, v6, p2}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;ILorg/apache/xmlbeans/XmlObject;)V
    :try_end_0
    ...
    const-string v6, "XmlException"

    invoke-virtual {v1}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object v1

    filled-new-array {v6, p0, v1}, [Ljava/lang/Object;

    move-result-object p0

    invoke-virtual {v5, v0, p0, p2}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
