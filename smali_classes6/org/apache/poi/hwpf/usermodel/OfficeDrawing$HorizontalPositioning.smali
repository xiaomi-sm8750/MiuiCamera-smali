...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;

    const-string v3, "INSIDE"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;->INSIDE:Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;
    ...
    invoke-direct {v3, v4, v5}, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;->LEFT:Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;

    new-instance v4, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;

    const-string v5, "OUTSIDE"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;->OUTSIDE:Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;
    ...
    invoke-direct {v5, v6, v7}, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;->RIGHT:Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;

    filled-new-array/range {v0 .. v5}, [Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;

    move-result-object v0

    sput-object v0, Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;->$VALUES:[Lorg/apache/poi/hwpf/usermodel/OfficeDrawing$HorizontalPositioning;
