...
.method public static doCHPOperation(Lorg/apache/poi/hdf/model/hdftypes/CharacterProperties;Lorg/apache/poi/hdf/model/hdftypes/CharacterProperties;II[B[BILorg/apache/poi/hdf/model/hdftypes/StyleSheet;)V
    ...
    :pswitch_4
    add-int/lit8 p0, p6, -0x4

    invoke-static {p5, p0}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S
    ...
    invoke-virtual {p1, p3}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setBrc([S)V
    ...
    invoke-virtual {p1, p3}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setDttmRMarkDel([S)V
    ...
    invoke-static {p4, v3}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S

    move-result p3

    invoke-virtual {p1, p3}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setIbstDispFldRMark(I)V

    invoke-static {p4, v4}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I
    ...
    invoke-static {p4, p3, p2, v0, p0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    :pswitch_2d
    invoke-virtual {p1, v3}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFSpec(Z)V
    ...
    invoke-static {p4, v1}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S
    ...
    :cond_16
    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFBold(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFItalic(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFOutline(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFStrike(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFShadow(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFSmallCaps(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFCaps(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setFVanish(Z)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setKul(B)V

    invoke-virtual {p1, v0}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setIco(B)V
    ...
    invoke-virtual {p1, p3}, Lorg/apache/poi/hdf/model/hdftypes/definitions/CHPAbstractType;->setDttmRMark([S)V
...
.method public static uncompressProperty([BLjava/lang/Object;Lorg/apache/poi/hdf/model/hdftypes/StyleSheet;Z)Ljava/lang/Object;
    ...
    invoke-static {v8, v15}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S
    ...
    .line 18
    invoke-static {v8, v2}, Lorg/apache/poi/util/LittleEndian;->getUnsignedByte([BI)I
    ...
    .line 19
    :cond_4
    invoke-static {v8, v2}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S
    ...
    .line 21
    invoke-static {v8, v0, v3, v15, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    .line 23
    :pswitch_3
    invoke-static {v8, v2}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I
