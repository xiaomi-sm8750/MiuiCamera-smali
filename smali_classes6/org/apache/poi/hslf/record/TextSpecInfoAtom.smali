...
.method public getTextSpecInfoRuns()[Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;
    ...
    new-instance v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;

    invoke-direct {v6}, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;-><init>()V

    iget-object v7, p0, Lorg/apache/poi/hslf/record/TextSpecInfoAtom;->_data:[B

    invoke-static {v7, v5}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I

    move-result v7

    iput v7, v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;->len:I

    add-int/lit8 v7, v5, 0x4

    iget-object v8, p0, Lorg/apache/poi/hslf/record/TextSpecInfoAtom;->_data:[B

    invoke-static {v8, v7}, Lorg/apache/poi/util/LittleEndian;->getInt([BI)I

    move-result v7

    iput v7, v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;->mask:I
    ...
    iget v8, v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;->mask:I
    ...
    invoke-static {v8, v5}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S

    move-result v8

    iput-short v8, v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;->altLangId:S
    ...
    iput-short v8, v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;->langId:S
    ...
    iput-short v8, v6, Lorg/apache/poi/hslf/record/TextSpecInfoAtom$TextSpecInfoRun;->spellInfo:S
