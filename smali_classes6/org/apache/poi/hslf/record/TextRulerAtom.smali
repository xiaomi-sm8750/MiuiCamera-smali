...
.method public static getParagraphInstance()Lorg/apache/poi/hslf/record/TextRulerAtom;
    ...
    new-instance v3, Lorg/apache/poi/hslf/record/TextRulerAtom;

    invoke-direct {v3, v2, v0, v1}, Lorg/apache/poi/hslf/record/TextRulerAtom;-><init>([BII)V
...
.method private read()V
    ...
    :pswitch_0
    iget-object v7, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->_data:[B

    invoke-static {v7, v3}, Lorg/apache/poi/util/LittleEndian;->getShort([BI)S

    move-result v7

    add-int/lit8 v3, v3, 0x2

    iget-object v8, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->textOffsets:[I
    ...
    iget-object v8, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->bulletOffsets:[I
    ...
    iput-object v7, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->tabStops:[I

    move v7, v2

    :goto_1
    iget-object v8, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->tabStops:[I

    array-length v9, v8

    if-ge v7, v9, :cond_0

    iget-object v9, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->_data:[B

    invoke-static {v9, v3}, Lorg/apache/poi/util/LittleEndian;->getUShort([BI)I
    ...
    iput v7, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->numLevels:I
    ...
    iput v7, p0, Lorg/apache/poi/hslf/record/TextRulerAtom;->defaultTabSize:I
