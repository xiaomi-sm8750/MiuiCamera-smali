...
.method public addSlideLookup(II)V
    ...
    invoke-static {v3, v1, p1}, Lorg/apache/poi/util/LittleEndian;->putInt([BII)V

    add-int/2addr v1, v6

    invoke-static {v3, v1, p2}, Lorg/apache/poi/util/LittleEndian;->putInt([BII)V

    iput-object v3, p0, Lorg/apache/poi/hslf/record/PersistPtrHolder;->_ptrData:[B

    iget-object p0, p0, Lorg/apache/poi/hslf/record/PersistPtrHolder;->_header:[B

    invoke-static {p0, v6, v2}, Lorg/apache/poi/util/LittleEndian;->putInt([BII)V
