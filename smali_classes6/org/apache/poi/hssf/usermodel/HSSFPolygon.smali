...
.method public setPoints([I[I)V
    ...
    sget-object v2, Lorg/apache/poi/hssf/usermodel/HSSFPolygon;->logger:Lorg/apache/poi/util/POILogger;

    const-string v3, "HSSFPolygon must have at least one point"
    ...
    invoke-direct {v2, v3, v4, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;-><init>(SZ[B)V
    ...
    invoke-static {v5, v4, v6}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    aget v6, p2, v3

    int-to-short v6, v6

    invoke-static {v5, v1, v6}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    invoke-virtual {v2, v3, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-static {v5, v4, v7}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    aget p2, p2, v4

    int-to-short p2, p2

    invoke-static {v5, v1, p2}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    invoke-virtual {v2, v3, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V

    invoke-virtual {p0, v2}, Lorg/apache/poi/hssf/usermodel/HSSFShape;->setPropertyValue(Lorg/apache/poi/ddf/EscherProperty;)V
    ...
    invoke-direct {p2, v2, v4, v3}, Lorg/apache/poi/ddf/EscherArrayProperty;-><init>(SZ[B)V
    ...
    invoke-virtual {p2, v2}, Lorg/apache/poi/ddf/EscherArrayProperty;->setNumberOfElementsInArray(I)V
    ...
    invoke-virtual {p2, v2}, Lorg/apache/poi/ddf/EscherArrayProperty;->setNumberOfElementsInMemory(I)V

    new-array v2, v1, [B

    fill-array-data v2, :array_0

    invoke-virtual {p2, v4, v2}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V

    new-array v2, v1, [B

    fill-array-data v2, :array_1

    invoke-virtual {p2, v0, v2}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-virtual {p2, v3, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-virtual {p2, v2, v3}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-virtual {p2, p1, v2}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
