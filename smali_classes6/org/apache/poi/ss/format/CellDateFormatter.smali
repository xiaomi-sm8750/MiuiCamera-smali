...
.method public formatValue(Ljava/lang/StringBuffer;Ljava/lang/Object;)V
    ...
    sget-object v4, Ljava/text/DateFormat$Field;->MILLISECOND:Ljava/text/DateFormat$Field;
    ...
    iget-object v8, p0, Lorg/apache/poi/ss/format/CellDateFormatter;->sFmt:Ljava/lang/String;
    ...
    invoke-virtual {v4, v1, v8, v6}, Ljava/util/Formatter;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/util/Formatter;

    add-int/lit8 v1, v2, 0x2

    invoke-virtual {p1, v2, v1}, Ljava/lang/StringBuffer;->delete(II)Ljava/lang/StringBuffer;
    ...
    :cond_3
    sget-object v4, Ljava/text/DateFormat$Field;->AM_PM:Ljava/text/DateFormat$Field;
    ...
    iget-boolean v3, p0, Lorg/apache/poi/ss/format/CellDateFormatter;->showAmPm:Z

    if-eqz v3, :cond_5

    iget-boolean v3, p0, Lorg/apache/poi/ss/format/CellDateFormatter;->amPmUpper:Z
