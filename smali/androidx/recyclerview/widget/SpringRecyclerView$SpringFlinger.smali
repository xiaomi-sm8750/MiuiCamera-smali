...
.method public notifyHorizontalEdgeReached(I)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lyi/d;
    ...
    iget p0, v1, Lyi/d$a;->h:I

    if-nez p0, :cond_1

    iget-object p0, v1, Lyi/b;->r:Lyi/b$b;

    if-eqz p0, :cond_0

    invoke-virtual {v1}, Lyi/b;->h()V

    :cond_0
    iget-wide p0, v1, Lyi/d$a;->d:D
    ...
    invoke-virtual/range {v1 .. v6}, Lyi/b;->j(IIIII)V
...
.method public notifyVerticalEdgeReached(I)V
    ...
    iget-object v1, v0, Lyi/d;->c:Lyi/b;
...
.method public springBack(II)V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lyi/d;
    ...
    invoke-virtual/range {v2 .. v8}, Lyi/d;->d(IIIIII)Z
